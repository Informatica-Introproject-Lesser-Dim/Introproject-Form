namespace IntroProject
{
    static class Settings
    {
        ...
        public static int TotalEntities = 50; //Verstand? en anders in Map
        public static int StartEntities = 20; //MenuScreen updates on new creation
        public static int HatchSpeed = 20; //YET TO COME?
        ...
        public static int MinTemp = 15; //Map.cs update on new creation
        public static int MaxTemp = 25; //Map.cs? update on new creation
