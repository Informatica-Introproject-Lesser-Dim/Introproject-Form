...
namespace IntroProject
{
    static class Path
    {
        ...
        private static Curve[] calcCurve(double r, int x, int y, double start, double turn) //start and the amount it turns are in radial coordinates
        { 
            double length = 2 * r * turn * 0.5; //just plain calculating circumfrence of a circle
        ...
        private static Curve calcStraight(int x1, int y1, int x2, int y2)
        {
            ...
            //move along the line with the correct step size
