...
namespace IntroProject
{
    ...
    {
        private static float jumpBias = 0.001f; /* Settings.JumpEnergy */
        private static float moveBias = 0.1f; /* Settings.WalkEnergy */ //mess a bit with these values when we got everything else set up correctly
        private static float standardBias = 0.00001f; /* Settings.PassiveEnergy */
